...
* [x] Added support for Priority for todo items (and display within listview item)
* [x] Added Done Status for every todo task.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/OlFMc5C.gif' title='Video Walkthrough' width='584' alt='Video Walkthrough' />
